...
/// - `ORIGINALNAME` is fetched to match a company with several masters to
///   its `CURRENCYNAME`, which identifies the base master; it never decides
///   INR (bridge#551, TALLY_PROTOCOL_REFERENCE §9.10a.2).
