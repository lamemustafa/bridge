...
fn native_party_master_collection(fields: &str) -> String {
    format!(
        "<ENVELOPE><HEADER><STATUS>1</STATUS></HEADER><BODY><DATA><COLLECTION><LEDGER NAME=\"Bridge self-closing master field\"><GUID>56359347-3976-4d01-b44e-56fa0f6a422c-000000ce</GUID><MASTERID>206</MASTERID><ALTERID>208</ALTERID><PARENT>Sundry Debtors</PARENT><OPENINGBALANCE>0.00</OPENINGBALANCE>{fields}</LEDGER></COLLECTION></DATA></BODY></ENVELOPE>"
    )
}
