            ...
            let posted = self
                ...
                .post_approved_import(
                    ...
                    || {
                        ...
                        if self.import_remote_ids_recorded_while_admitted(native.remote_ids.as_slice())? {
...
pub(super) fn finalize_previous_attempt_reconciliation(
    ...
    let name_verified = verification_status(&payload["result"], voucher_count)
        == "posted_verified"
...
fn recheck_import_admission(
    ...
    require_absent_verification_result(&result, line.vouchers.len()).map_err(|code| match code.as_str() {
