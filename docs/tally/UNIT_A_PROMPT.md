...
4. docs/internal/PRODUCT.md — the screen you are building toward (users, purpose, design principles).
...
Computed locally from vouchers and bill allocations. See docs/internal/PRODUCT.md for the
