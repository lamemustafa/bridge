...
| Remote agent on client machines (a long-running executor daemon, and the reserved `bridge-daemon` stub removed on 2026-09-17, are this item under other names) | Fleet product a solo dev cannot operate; reputational risk lands on the firm. Reaffirmed 2026-09-17: staying parked pending a larger team — not a reversal, just naming the stub as the same parked item | Cloud relay + support capacity exist |
