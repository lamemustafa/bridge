...
13. **Multi-currency books, #551.** A voucher's amounts are plain base-currency figures, and a
    ...
    seen, or `import_base_currency_undetermined` when none can be read). This refuses every post
