...
[docs/tally/TALLY_INTEGRATION_RESEARCH_AND_CODEX_PLAN.md](../tally/TALLY_INTEGRATION_RESEARCH_AND_CODEX_PLAN.md).

Keep implementation status and public claims in the adjacent
[Tally support matrix](../tally/support-matrix.md); roadmap items are not
